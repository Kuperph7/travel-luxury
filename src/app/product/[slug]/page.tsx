...
const ProductDetailPage = ({params}: any) => {
  ...
  console.log(params.slug, 'router')

  const product = PRODUCTS.find((p) => p.link?.includes(params.slug));
  //

  console.log(product, 'product')

  const [variantActive, setVariantActive] = useState(0);
  const [sizeSelected, setSizeSelected] = useState(product?.sizes ? product?.sizes[0] : "");
